  ...
  return (
    <section className={styles.technologies}>
      <div className="container">
        <h1 className={styles.title}>{t('technologies.title')}</h1>
        <p className={styles.description}>{t('technologies.description')}</p>

        <h2 className={styles.subtitle}>{t('technologies.missionTitle')}</h2>
        <p className={styles.mission}>{t('technologies.mission')}</p>

        <h2 className={styles.subtitle}>{t('technologies.partnersTitle')}</h2>
